...
- If you overrun, the first 14 seconds is the cut. The venue checker has to be on screen by
  0:20, since it is now the headline of the page rather than a field inside the scoping form.
